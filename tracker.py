...
# class AmazoneAPI:
#     def __init__(self, search_tearm, filters, base_url, currency):
#         self.base_url = base_url
#         self.search_tearm = search_tearm
#         options = get_web_driver_options()
#         set_ignore_certificate_error(options)
#         set_browser_as_incognito(options)
#         self.driver = get_chrome_web_driver(options)
#         self.currency = currency
#         self.price_filter = "&rh=p_36%3A" + filters['min'] + "00-" + filters['max'] + "00"
#         # self.price_filter = f"&rh=p_36%3A{filter['min']}00-{filters['max']}00"
#         pass

#     def run(self):
#         print("Starting Script 🚀")
#         print(f"Looking for {self.search_tearm} product")
...
#         # This command helps ud to quit the browser afte the work,
#         #  So that we donot need to quit browser manualy 👇
#         self.driver.quit()
...
#         print(f"Product Id: {asin} - getting the data... 🔍🔍🔍")
...
#             print(e)
#             print(f"Can't get the title of products - {self.driver.current_url}")
#             return None
...
#         except Exception as e:
#             print('e')
#             print(f"Failed to get the Seller from {self.driver.current_url}")
#             return None
...
#         return product_link[product_link.find('/db/') + 4:product_link.find('/ref')]

#     def get_products_links(self):

#         # In This statement we are calling the base_url(amazon.de) to be opened in selenium browser!🔥
#         self.driver.get(self.base_url)
#         element = self.driver.find_element_by_id('twotabsearchtextbox')
#         element.send_keys(self.search_tearm)
#         element.send_keys(Keys.ENTER)
#         time.sleep(2)
#         self.driver.get(f"{self.driver.current_url}{self.price_filter}")
#         time.sleep(2) # Waiting to reload
...
#             print(e)
#             return links
#         # Main Output occure here 👇👇


# if __name__ == "__main__":
#     print("\n\n\n\n")
#     amazon = AmazoneAPI(NAME, FILTERS, BASE_URL, CURRENCY)
#     amazon.run()
